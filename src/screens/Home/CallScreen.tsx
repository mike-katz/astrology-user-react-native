...
// });
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true);
    setTimeout(() => {
      setData(initialData.map((d, i) => ({ ...d, id: i + 1, orders: Math.floor(Math.random() * 20000) })));
      setRefreshing(false);
    }, 900);
  }, []);
    ...
    <View style={styles.cardWrap}>
      <View style={styles.card}>
        <View style={styles.left}>
          <FastImage source={{ uri: item.avatar }} style={[styles.avatar,{borderColor:activeFilterColor}]} />
          <View style={styles.metaRow}>
            <View style={styles.starsRow}>
              <Feather name="star" size={10} color="#888" style={styles.starIcon}/>
              <Feather name="star" size={10} color="#888" style={styles.starIcon}/>
              <Feather name="star" size={10} color="#888" style={styles.starIcon}/>
              <Feather name="star" size={10} color="#888" style={styles.starIcon}/>
              <Feather name="star" size={10} color="#888" />
            </View>
        ...
        <View style={styles.right}>
          ...
          <RightGreenIcon width={16} height={16} />
          </View>
...
iconWrap: {
  ...
  card: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 0.6, borderColor: '#E6E6E6', shadowColor: '#000', shadowOpacity: 0.03, shadowRadius: 6, elevation: 2 },
  left: { marginRight: 12 },
  avatar: { width: 66, height: 66, borderRadius: 33, borderWidth: 2, borderColor: '#F1C42B', backgroundColor: '#fff' },
  center: { flex: 1 },
